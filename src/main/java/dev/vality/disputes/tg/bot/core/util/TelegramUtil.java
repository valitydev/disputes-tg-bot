...
public class TelegramUtil {
    ...
    private static final int maxCallbackContextSizeBytes = 64;
    ...
    public static boolean isCallbackContextSizeValid(String contextString) {
        if (ObjectUtils.isEmpty(contextString)) {
            return true;
        }
